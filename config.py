...
API_HASH = os.getenv("API_HASH", "2de42d28d36e637c54d5571df5679b7d")
BOT_TOKEN = os.getenv("BOT_TOKEN", "7714224903:AAEI8X6z_A34C5mDlOQcCaTXBkKnp5Q0uTs")

# session string assistant/user yang akan join VC
...
# YouTube Data API v3 key (buat search keyword)
YOUTUBE_API_KEY = os.getenv("YOUTUBE_API_KEY", "AIzaSyDUsnrgyghsrZ3HLErNes8SGX5mONi5vWk")
